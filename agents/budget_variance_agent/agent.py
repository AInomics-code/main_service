...
class BudgetVarianceAgent(BaseAgent):
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_template(BUDGET_VARIANCE_PROMPT)
    ...
    def fetch_budget_variance(self, user_input: str) -> str:
