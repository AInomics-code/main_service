...
class CoverageAnalyzerAgent(BaseAgent):
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_template(COVERAGE_ANALYZER_PROMPT)
    ...
    def analyze_coverage(self, user_input: str) -> str:
