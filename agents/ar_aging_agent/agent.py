...
class ARAgingAgent(BaseAgent):
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_template(AR_AGING_PROMPT)
    ...
    def check_ar_aging(self, user_input: str) -> str:
