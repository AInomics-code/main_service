...
class TrendDetectorAgent(BaseAgent):
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_template(TREND_DETECTOR_PROMPT)
    ...
    def detect_trend(self, user_input: str) -> str:
