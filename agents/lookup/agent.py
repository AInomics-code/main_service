...
class LookupAgent(BaseAgent):
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_template(LOOKUP_PROMPT)
    ...
    def lookup_data(self, user_input: str) -> str:
