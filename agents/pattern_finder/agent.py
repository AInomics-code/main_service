...
class PatternFinderAgent(BaseAgent):
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_template(PATTERN_FINDER_PROMPT)
    ...
    def find_patterns(self, user_input: str) -> str:
