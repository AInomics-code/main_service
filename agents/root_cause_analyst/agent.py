...
class RootCauseAnalystAgent(BaseAgent):
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_template(ROOT_CAUSE_PROMPT)
    ...
    def analyze_root_cause(self, user_input: str) -> str:
