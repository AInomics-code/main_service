...
def generate_complete_schema_files(output_folder: str = "schema_files"):
    """
    Genera archivos txt de esquema con todas las tablas del JSON original.
    ...
    # JSON completo de la base de datos con todas las 26 tablas
    db_schema = {
        ...
        "tables": [
            ...
            {
                "table_name": "corregimientos",
                "description": "Tabla que contiene los corregimientos disponibles",
                "columns": [
                    {"column_name": "codigo_de_corregimiento", "data_type": "nvarchar", "description": "Código único del corregimiento"},
                    {"column_name": "nombre_de_corregimiento", "data_type": "nvarchar", "description": "Nombre del corregimiento"}
                ]
            },
            {
                "table_name": "depositos",
                "description": "Tabla que contiene información de los depósitos o almacenes",
                "columns": [
                    {"column_name": "codigo_de_deposito", "data_type": "nvarchar", "description": "Código único del depósito"},
                    {"column_name": "nombre_de_deposito", "data_type": "nvarchar", "description": "Nombre del depósito"},
                    {"column_name": "direccion", "data_type": "nvarchar", "description": "Dirección del depósito"},
                    {"column_name": "ciudad", "data_type": "nvarchar", "description": "Ciudad donde se encuentra el depósito"},
                    {"column_name": "telefono", "data_type": "nvarchar", "description": "Teléfono del depósito"},
                    {"column_name": "gerente", "data_type": "nvarchar", "description": "Gerente responsable del depósito"}
                ]
            },
            {
                "table_name": "distritos",
                "description": "Tabla que contiene los distritos disponibles",
                "columns": [
                    {"column_name": "codigo_de_distrito", "data_type": "nvarchar", "description": "Código único del distrito"},
                    {"column_name": "nombre_de_distrito", "data_type": "nvarchar", "description": "Nombre del distrito"}
                ]
            },
            {
                "table_name": "gerentes",
                "description": "Tabla que contiene información de los gerentes",
                "columns": [
                    {"column_name": "codigo_de_gerente", "data_type": "nvarchar", "description": "Código único del gerente"},
                    {"column_name": "nombre_de_gerente", "data_type": "nvarchar", "description": "Nombre del gerente"},
                    {"column_name": "email", "data_type": "nvarchar", "description": "Email del gerente"},
                    {"column_name": "telefono", "data_type": "nvarchar", "description": "Teléfono del gerente"}
                ]
            },
            {
                "table_name": "gestor_de_cobros",
                "description": "Tabla que contiene información de los gestores de cobros",
                "columns": [
                    {"column_name": "codigo_de_gestor_de_cobros", "data_type": "nvarchar", "description": "Código único del gestor de cobros"},
                    {"column_name": "nombre_de_gestor_de_cobros", "data_type": "nvarchar", "description": "Nombre del gestor de cobros"}
                ]
            },
            {
                "table_name": "grupo_generico",
                "description": "Tabla que contiene los grupos genéricos de productos",
                "columns": [
                    {"column_name": "codigo_de_grupo_generico", "data_type": "numeric", "description": "Código único del grupo genérico"},
                    {"column_name": "nombre_de_grupo_generico", "data_type": "nvarchar", "description": "Nombre del grupo genérico"},
                    {"column_name": "unidad_de_medida", "data_type": "nvarchar", "description": "Unidad de medida del grupo genérico"}
                ]
            },
            {
                "table_name": "grupos",
                "description": "Tabla que contiene los grupos de clientes",
                "columns": [
                    {"column_name": "codigo_de_grupo", "data_type": "nvarchar", "description": "Código único del grupo"},
                    {"column_name": "nombre_de_grupo", "data_type": "nvarchar", "description": "Nombre del grupo"}
                ]
            },
            {
                "table_name": "impuestos",
                "description": "Tabla que contiene información de los impuestos",
                "columns": [
                    {"column_name": "codigo_de_impuesto", "data_type": "nvarchar", "description": "Código único del impuesto"},
                    {"column_name": "nombre_de_impuesto", "data_type": "nvarchar", "description": "Nombre del impuesto"},
                    {"column_name": "porcentaje_de_impuesto", "data_type": "float", "description": "Porcentaje del impuesto"}
                ]
            },
            {
                "table_name": "motivo_de_devolucion",
                "description": "Tabla que contiene los motivos de devolución",
                "columns": [
                    {"column_name": "codigo_de_motivo_de_devolucion", "data_type": "nvarchar", "description": "Código único del motivo de devolución"},
                    {"column_name": "nombre_de_motivo_de_devolucion", "data_type": "nvarchar", "description": "Nombre del motivo de devolución"},
                    {"column_name": "es_gasto", "data_type": "nvarchar", "description": "Indica si es un gasto"}
                ]
            },
            {
                "table_name": "paises",
                "description": "Tabla que contiene información de los países",
                "columns": [
                    {"column_name": "codigo_de_paises", "data_type": "nvarchar", "description": "Código único del país"},
                    {"column_name": "nombre_de_pais", "data_type": "nvarchar", "description": "Nombre del país"}
                ]
            },
            {
            ...
            {
                "table_name": "productos_por_deposito",
                "description": "Tabla que relaciona productos con depósitos y maneja inventario",
                "columns": [
                    {"column_name": "codigo_de_producto", "data_type": "nvarchar", "description": "Código del producto"},
                    {"column_name": "codigo_de_deposito", "data_type": "nvarchar", "description": "Código del depósito"},
                    {"column_name": "ubicacion1", "data_type": "nvarchar", "description": "Ubicación 1 del producto en el depósito"},
                    {"column_name": "ubicacion2", "data_type": "nvarchar", "description": "Ubicación 2 del producto en el depósito"},
                    {"column_name": "existencia", "data_type": "numeric", "description": "Cantidad existente en el depósito"},
                    {"column_name": "cantidad_separada", "data_type": "numeric", "description": "Cantidad separada para pedidos"},
                    {"column_name": "inventario_madre", "data_type": "numeric", "description": "Inventario madre del producto"},
                    {"column_name": "codigo_de_area_de_despacho", "data_type": "numeric", "description": "Código del área de despacho"}
                ]
            },
            {
                "table_name": "provincias",
                "description": "Tabla que contiene las provincias disponibles",
                "columns": [
                    {"column_name": "codigo_de_provincia", "data_type": "nvarchar", "description": "Código único de la provincia"},
                    {"column_name": "nombre_de_provincia", "data_type": "nvarchar", "description": "Nombre de la provincia"}
                ]
            },
            {
                "table_name": "rutas",
                "description": "Tabla que contiene información de las rutas de venta",
                "columns": [
                    {"column_name": "codigo_de_ruta", "data_type": "nvarchar", "description": "Código único de la ruta"},
                    {"column_name": "nombre_de_ruta", "data_type": "nvarchar", "description": "Nombre de la ruta"},
                    {"column_name": "codigo_de_vendedor", "data_type": "nvarchar", "description": "Código del vendedor asignado a la ruta"},
                    {"column_name": "dia_visita", "data_type": "nvarchar", "description": "Día de visita de la ruta"},
                    {"column_name": "frecuencia", "data_type": "int", "description": "Frecuencia de visita"},
                    {"column_name": "semana", "data_type": "int", "description": "Semana de la ruta"}
                ]
            },
            {
                "table_name": "supervisor_trade",
                "description": "Tabla que contiene información de los supervisores trade",
                "columns": [
                    {"column_name": "codigo_supervisor_trade", "data_type": "nvarchar", "description": "Código único del supervisor trade"},
                    {"column_name": "nombre_supervisor_trade", "data_type": "nvarchar", "description": "Nombre del supervisor trade"},
                    {"column_name": "email", "data_type": "nvarchar", "description": "Email del supervisor trade"},
                    {"column_name": "telefono", "data_type": "nvarchar", "description": "Teléfono del supervisor trade"}
                ]
            },
            {
                "table_name": "tipos",
                "description": "Tabla que contiene los tipos de productos",
                "columns": [
                    {"column_name": "codigo_de_tipo", "data_type": "nvarchar", "description": "Código único del tipo"},
                    {"column_name": "nombre_de_tipo", "data_type": "nvarchar", "description": "Nombre del tipo"}
                ]
            },
            {
                "table_name": "tipos_de_negocio",
                "description": "Tabla que contiene los tipos de negocio",
                "columns": [
                    {"column_name": "codigo_de_tipo_de_negocio", "data_type": "nvarchar", "description": "Código único del tipo de negocio"},
                    {"column_name": "nombre_de_tipo_de_negocio", "data_type": "nvarchar", "description": "Nombre del tipo de negocio"},
                    {"column_name": "codigo_de_canal", "data_type": "nvarchar", "description": "Código del canal asociado"}
                ]
            },
            {
                "table_name": "transacciones_inventario",
                "description": "Tabla que registra las transacciones de inventario",
                "columns": [
                    {"column_name": "documento", "data_type": "nvarchar", "description": "Número de documento de la transacción"},
                    {"column_name": "fecha", "data_type": "datetime", "description": "Fecha de la transacción"},
                    {"column_name": "tipo_de_transaccion", "data_type": "nvarchar", "description": "Tipo de transacción de inventario"},
                    {"column_name": "cantidad", "data_type": "numeric", "description": "Cantidad de la transacción"},
                    {"column_name": "costo", "data_type": "numeric", "description": "Costo de la transacción"},
                    {"column_name": "codigo_de_producto", "data_type": "nvarchar", "description": "Código del producto"},
                    {"column_name": "codigo_de_proveedor", "data_type": "nvarchar", "description": "Código del proveedor"},
                    {"column_name": "codigo_de_deposito", "data_type": "nvarchar", "description": "Código del depósito"},
                    {"column_name": "factor_de_conversion", "data_type": "numeric", "description": "Factor de conversión"},
                    {"column_name": "lote", "data_type": "nvarchar", "description": "Número de lote"},
                    {"column_name": "fecha_de_vencimiento", "data_type": "datetime", "description": "Fecha de vencimiento"},
                    {"column_name": "fecha_de_produccion", "data_type": "datetime", "description": "Fecha de producción"},
                    {"column_name": "clasificacion_de_ajuste", "data_type": "nvarchar", "description": "Clasificación del ajuste"},
                    {"column_name": "cantidad_contada_en_el_inventario_fisico", "data_type": "float", "description": "Cantidad contada en inventario físico"},
                    {"column_name": "consecutivo", "data_type": "numeric", "description": "Número consecutivo"}
                ]
            },
            {
                "table_name": "vendedores",
                "description": "Tabla que contiene información de los vendedores",
                "columns": [
                    {"column_name": "codigo_de_vendedor", "data_type": "nvarchar", "description": "Código único del vendedor"},
                    {"column_name": "nombre_de_vendedor", "data_type": "nvarchar", "description": "Nombre del vendedor"},
                    {"column_name": "cedula", "data_type": "nvarchar", "description": "Cédula del vendedor"},
                    {"column_name": "codigo_de_provincia", "data_type": "nvarchar", "description": "Código de la provincia"},
                    {"column_name": "codigo_de_distrito", "data_type": "nvarchar", "description": "Código del distrito"},
                    {"column_name": "codigo_de_corregimiento", "data_type": "nvarchar", "description": "Código del corregimiento"},
                    {"column_name": "email", "data_type": "nvarchar", "description": "Email del vendedor"},
                    {"column_name": "telefono", "data_type": "nvarchar", "description": "Teléfono del vendedor"},
                    {"column_name": "codigo_de_jefe", "data_type": "nvarchar", "description": "Código del jefe del vendedor"},
                    {"column_name": "codigo_de_ruta", "data_type": "nvarchar", "description": "Código de la ruta asignada"},
                    {"column_name": "codigo_de_gerente", "data_type": "nvarchar", "description": "Código del gerente"},
                    {"column_name": "codigo_de_supervisor", "data_type": "nvarchar", "description": "Código del supervisor"},
                    {"column_name": "fecha_ultima_venta", "data_type": "datetime", "description": "Fecha de la última venta"},
                    {"column_name": "fecha_ultima_devolucion", "data_type": "datetime", "description": "Fecha de la última devolución"},
                    {"column_name": "estado", "data_type": "nvarchar", "description": "Estado del vendedor"}
                ]
            },
            {
                "table_name": "ventas",
    ...
    # Generar archivos
    generate_schema_files(db_schema, output_folder)
    print(f"Archivos de esquema completos generados exitosamente! Total de tablas: {len(db_schema['tables'])}")
...
if __name__ == "__main__":
    generate_complete_schema_files() 